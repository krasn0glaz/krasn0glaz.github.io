...
# System config
use constant ADMIN_PASS => 'adminebashit';			# Admin password. For fucks's sake, change this.
use constant SECRET => 'a3Jhc24wZ2xhei5lYmFzaC5pdAo=';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'e/b/ach - сиди дома и не выёбывайся';	# Name of this image board
...
use constant TITLEIMG => '../favicon.ico';			# Title image (point to a script file if rotating)
...
use constant S_ANONAME => 'пхпшник';			# Defines what to print if there is no text entered in the name field
...
use constant AUTOCLOSE_POSTS => 400;				# Maximum number of posts before a thread closes. 0 to disable.
use constant AUTOCLOSE_DAYS => 90;				# Maximum number of days with no activity before a thread closes. 0 to disable.
#use constant AUTOCLOSE_SIZE => 0;				# Maximum size of the thread HTML file in kilobytes before a thread closes. 0 to disable.
use constant MAX_RES => 40;					# Maximum topic bumps
...
use constant FORBIDDEN_EXTENSIONS => ('php','php3','php4','phtml','shtml','cgi','pl','pm','py','r','exe','dll','scr','pif','asp','cfm','jsp','vbs','sh'); # file extensions which are forbidden
